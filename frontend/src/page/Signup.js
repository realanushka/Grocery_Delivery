  ...
  const handleSubmit =async (e) => {
    ...
    if (firstName && email && password && confirmPassword) {
      if( password === confirmPassword ) {
        ...
        alert("Please enter check the password!");
      }
      ...
      <div className='w-full max-w-sm bg-white m-auto flex flex-col p-2'>
        ...
        <div className='w-20 h-20 overflow-hidden rounded-full drop-shadow-md shadow-md m-auto relative'>
          ...
          <label htmlFor='profileImage'>
            ...
            {/* <input id='removeprofileImage' accept='image/*' className='hidden' onChange={handleRemoveProfileImage}/> */}
          </label>
        </div>
        ...
        <form className='w-full py-3 flex flex-col' onSubmit={handleSubmit}>
          ...
          <button className='w-full max-w-[150px] m-auto bg-red-500 hover:bg-red-700 cursor-pointer text-white text-xl font-medium text-center py-1 rounded-full mt-4'>Sign Up</button>
        </form>
